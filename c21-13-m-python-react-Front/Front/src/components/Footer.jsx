    ...
    return(
        <footer className="bg-gray-900 text-gray-400 py-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div>
                    <h4 className="text-white text-lg font-semibold mb-4">Cursos</h4>
                    <ul className="space-y-2">
                        <li><a href="#" className="hover:text-white transition-colors">Desarrollo Web</a></li>
                        <li><a href="#" className="hover:text-white transition-colors">Ciencia de Datos</a></li>
                    ...
                    <ul className="space-y-2">
                        <li><a href="#" className="hover:text-white transition-colors">Ayuda y Soporte</a></li>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li><a href="#" className="hover:text-white transition-colors">Configuración de Cookies</a></li>
                    </ul>
                    </div>
                </div>
